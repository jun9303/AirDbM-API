...
| `xfoil_retry` | `int` | `1` | Number of XFOIL reattempts for a candidate. This helps recover transient deadlock/no-parse behavior in multiprocessing, where a design may still converge in another attempt. |
